...
public class PrescriptionReports {
    ...
    /**
     * Prints a past-year prescription summary for all patients by medication name.
     */
    public void patientPrescriptionPastYear() {
        ...
        for (Patient patient : system.getPatients()) {
            ...
            for (Prescription prescription : prescriptions) {
                if (prescription == null || prescription.getExpires() == null) {
                    continue;
                }
        ...
        if (medicationCounts.isEmpty()) {
            System.out.println("No prescriptions in the past year for any patient.");
            return;
        }

        System.out.println("Past-year medication summary for all patients:");
