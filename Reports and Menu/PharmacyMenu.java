            ...
            switch (choice) {
                ...
                case "1":
                    ...
                    switch (addChoice) {
                        ...
                        case "3":
                            ...
                            system.addMedication(new Medication(medicationName, dosage, quantity));
                ...
                case "2":
                    ...
                    switch (deleteChoice) {
                        ...
                        case "1":
                            System.out.print("Patient name: ");
                            Patient patientToDelete = system.searchPatient(input.nextLine().trim());
                        ...
                        case "2":
                            System.out.print("Doctor name: ");
                            Doctor doctorToDelete = system.searchDoctor(input.nextLine().trim());
                        ...
                        case "3":
                            System.out.print("Medication name: ");
                            Medication medToDelete = system.searchMedication(input.nextLine().trim());
                            if (medToDelete == null) {
                ...
                case "3":
                    ...
                    switch (editChoice) {
                        ...
                        case "1":
                            ...
                            Patient patientToEdit = system.searchPatient(input.nextLine().trim());
                        ...
                        case "2":
                            ...
                            Doctor doctorToEdit = system.searchDoctor(input.nextLine().trim());
                        ...
                        case "3":
                            ...
                            Medication medToEdit = system.searchMedication(input.nextLine().trim());
                            if (medToEdit == null) {
                                System.out.println("Medication not found.");
                                break;
                            }
                ...
                case "4":
                    ...
                    switch (searchChoice) {
                        ...
                        case "1":
                            System.out.print("Patient name: ");
                            Patient foundPatient = system.searchPatient(input.nextLine().trim());
                            System.out.println(foundPatient == null ? "Patient not found." : foundPatient);
                            break;
                        case "2":
                            System.out.print("Doctor name: ");
                            Doctor foundDoctor = system.searchDoctor(input.nextLine().trim());
                            System.out.println(foundDoctor == null ? "Doctor not found." : foundDoctor);
                            break;
                        case "3":
                            System.out.print("Medication name: ");
                            Medication foundMedication = system.searchMedication(input.nextLine().trim());
                ...
                case "5":
                    System.out.print("Doctor name: ");
                    Doctor prescriptionDoctor = system.searchDoctor(input.nextLine().trim());
                    System.out.print("Patient name: ");
                    Patient prescriptionPatient = system.searchPatient(input.nextLine().trim());
                    System.out.print("Medication name: ");
                    Medication prescriptionMedication = system.searchMedication(input.nextLine().trim());
                ...
                case "6":
                    System.out.print("Doctor name: ");
                    Doctor doctorForAssignment = system.searchDoctor(input.nextLine().trim());
                    System.out.print("Patient name: ");
                    Patient patientForAssignment = system.searchPatient(input.nextLine().trim());
                ...
                case "9":
                    System.out.print("Doctor name: ");
                    Doctor reportDoctor = system.searchDoctor(input.nextLine().trim());
                ...
                case "10":
                    System.out.print("Patient name: ");
                    Patient reportPatient = system.searchPatient(input.nextLine().trim());
                ...
                case "11":
                    System.out.print("Medication name: ");
                    Medication medToRestock = system.searchMedication(input.nextLine().trim());
